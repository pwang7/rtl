...
\TLV
   ...
   |cpu
      @0
         ...
         //$pc[31:0] = >>1$reset ? 0 : >>3$valid_taken_br ? >>3$br_tgt_pc : >>3$inc_pc;
         //$pc[31:0] = >>1$reset ? 0 : >>3$valid_taken_br ? >>3$br_tgt_pc : >>1$inc_pc;
         $pc[31:0] = >>1$reset ? 0 :
      ...
      @2
         ...
         $src1_value[31:0] = (>>1$rf_wr_en && $rf_rd_index1 == >>1$rf_wr_index) ? >>1$result : $rf_rd_data1;
         $src2_value[31:0] = (>>1$rf_wr_en && $rf_rd_index2 == >>1$rf_wr_index) ? >>1$result : $rf_rd_data2;
      ...
      @3
         ...
         //$valid_taken_br = $taken_br;
      @4
         $dmem_wr_en = $valid && $is_s_instr;
         $dmem_rd_en = $is_load;
         $dmem_addr[3:0] = $result[5:2];
         $dmem_wr_data[31:0] = $src2_value;
         //$dmem_rd_index[5:0] = $result[5:0];
      @5
