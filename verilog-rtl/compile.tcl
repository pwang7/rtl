...
#analyze -format verilog [list axi_dma.v DmaMem.v define.v]
#elaborate      $TOP_MODULE -architecture verilog
read_file $RTL_PATH -autoread -format verilog -top $TOP_MODULE
...
set auto_wire_load_selection  false;           #DC不采用自动线负载模型
